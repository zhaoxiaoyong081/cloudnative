...
docker pull  registry.cn-wulanchabu.aliyuncs.com/moge1/kube-state-metrics:v2.3.1
docker tag  registry.cn-wulanchabu.aliyuncs.com/moge1/kube-state-metrics:v2.3.1 k8s.gcr.io/kube-state-metrics/kube-state-metrics:v2.2.4
...
Mitb3j0T1BfBniRarYHk2bEE99iM9Muv14Hr039n
